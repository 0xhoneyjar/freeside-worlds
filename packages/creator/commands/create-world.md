...
/create-world resume <slug>           resume a draft at grimoires/freeside-worlds/drafts/<slug>/
...
- Write access to `0xHoneyJar/freeside-worlds` (for the registry PR in Stage 9)
...
| Stage | Artifact |
|---|---|
| 1 | `grimoires/freeside-worlds/drafts/<slug>/intent.md` — captured world thesis |
| 3 | a fresh `<slug>-world/` repo from `packages/base/starter` |
| 5 | `<slug>-world/freeside-worlds.yaml` — Component attachments declared |
| 9 | PR to `freeside-worlds/packages/registry/worlds/<slug>.yaml` |
...
See `freeside-worlds/packages/creator/skills/creating-worlds/SKILL.md` for the full refusal table.
...
Authored 2026-04-28 as part of `freeside-worlds` MVP. Persona: COSMOGRAPHER. Skill: `creating-worlds`.
